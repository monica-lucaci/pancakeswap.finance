document.addEventListener("DOMContentLoaded", () => {
  ...
  const updateContent = () => {
    ...
    if (window.innerWidth <= 360) {
      ...
      imgSlide2.srcset = "./assets/images/carousel/perpetualMobile.webp";
      ...
      imgSlide6.srcset = "./assets/images/carousel/galxeTraverseMobile.png";
      textSlide7.textContent = "Base is LIVE!";
      textSlide8.textContent = "opBNB is LIVE!";
      imgSlide8.srcset = "./assets/images/carousel/opbnb-bg-mobile.webp";
