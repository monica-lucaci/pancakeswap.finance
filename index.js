...
const divSoleChild = document.querySelectorAll(".darkMode_chckbx_sun");
...
const body = document.body; // Assuming your content is inside an element with the 'body' id
